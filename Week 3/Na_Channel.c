...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 Na_Ch E:/EPFL-Masters/Second Semester/In Silico Neuroscience/In-Silico-Neuroscience-Projects/Week 3/Na_Channel.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "Na_Channel.mod";
static const char* nmodl_file_text = 
  "NEURON {\n"
  "	SUFFIX Na_Ch\n"
