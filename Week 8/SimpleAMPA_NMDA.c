...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 SimpleAMPA_NMDA E:/EPFL-Masters/Second Semester/In Silico Neuroscience/Week 8/Week8_Tutorial/Homework_week8/SimpleAMPA_NMDA.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "SimpleAMPA_NMDA.mod";
static const char* nmodl_file_text = 
  "COMMENT\n"
  "/**\n"
